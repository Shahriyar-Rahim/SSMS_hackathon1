...
const ServiceRequestForm = ({
  ...
  const selectedCategory = requestData.category || "Appliance & Gadget Repair";
  const categoryOptions = SERVICE_OPTIONS[selectedCategory] || [
    selectedCategory,
  ];

  const [formData, setFormData] = useState({
    serviceName: categoryOptions[0],
    customServiceName: "",
  ...
  const validateForm = () => {
    ...
    if (
      !formData.problemDetails.trim() ||
      formData.problemDetails.length < 10
    ) {
      newErrors.problemDetails =
        "Please provide at least a brief description (min 10 characters)";
    }
    setErrors(newErrors);
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit({
      ...
      urgency: formData.urgency === "Urgent" ? "HIGH" : "STANDARD",
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <form
        ...
        className="bg-white/90 backdrop-blur-xs border border-slate-200/80 rounded-2xl p-6 sm:p-8 space-y-6 shadow-sm"
      >
        <div className="space-y-4 pb-6 border-b border-slate-100">
          ...
          <div>
            ...
            >
              {categoryOptions.map((service, idx) => (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Regular base service charges apply.
                  </p>
                </div>
              </label>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Urgent priority assignment (+20% surcharge).
                  </p>
                </div>
              </label>
            </div>
        ...
        <div className="space-y-4">
          <h3 className="text-xs font-bold uppercase tracking-wider text-indigo-600 flex items-center gap-1.5">
            <AlertCircle className="w-3.5 h-3.5" /> 4. Issue Description &
            Attachments
          </h3>
